...
class MarketknowledgePage extends StatefulWidget {
  const MarketknowledgePage({Key key}) : super(key: key);

  @override
  _MarketknowledgePageState createState() => _MarketknowledgePageState();
}

class _MarketknowledgePageState
    extends ModularState<MarketknowledgePage, HomeController> {
  @override
