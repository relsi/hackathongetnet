...
class MarketingManagementPage extends StatefulWidget {
  const MarketingManagementPage({Key key}) : super(key: key);
...
class _MarketingManagementPageState
    extends ModularState<MarketingManagementPage, HomeController> {
  @override
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 24),
                  Text("Gestão de Marketing", style: kHeadingextStyle),
                  Text(
